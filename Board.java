...
public class Board extends JPanel
{
  ...
  // Grid colours
  private static final Color GRID_COLOR_A = new Color(169,169,169);
  private static final Color GRID_COLOR_B = new Color(192,192,192);
  ...
  {"yellow", "blue", "cyan", "green", "pink", "white", "red", "orange", "magenta", "hot_pink"};
